            ...
            <Navbar expand="md" bg="dark" variant="dark" sticky="top" id="navbar_top" className={location.pathname == "/" ? "" : "fixed-top"}>
              <Container id="navbar-container" fluid>
                  ...
                  <Navbar.Brand >
                    <Link to="/">
                      <div className="navbar-brand">
                        ...
                        <div className="navbar-brand-text text-start"><font style={{"color":"#СВ853А"}}>BITMEME</font><br />EXPLORER</div>
                      </div>
                    </Link>
                  </Navbar.Brand>
                </div>
                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                  ...
                  <div className='ms-auto navbar-price'>${price} <span className="text-light">/ BTM</span></div>
                </Navbar.Collapse>
              </Container>
            </Navbar>
                ...
                <Row><Col xs={12}>
                  <Form onSubmit={search} className="">
                    <InputGroup className="mt-4 mb-4 search-box-group">
                      <Form.Control className="d-inline-block bg-light text-dark shadow-none" name="searchbox" id="search-box-high" type="text" placeholder="Search for btm:address or block" />
          ...
          <div className="text-light footerfull d-flex flex-row justify-content-center px-0">
            <Container className="footer webpage px-sm-5 py-3 text-center madewith" fluid>
              <Row className="d-none d-sm-block">
                <Col>
                  Made with <font className="fs-5" color="red">♥</font> by BTM developers
                  <span className="ms-3">
