...
function Dashboard() {
  ...
  const [address, setAddress] = useState("btm:");
            ...
            <Col xs={11}>
              <Form onSubmit={search}>
                <InputGroup className="ms-md-5 mt-5 me-5 dashboard-search-box">
                  <Form.Control className="bg-light text-dark shadow-none" name="searchInput" type="text" placeholder="Search for btm:address or block" />
