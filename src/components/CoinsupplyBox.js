            ...
            <table style={{ fontSize: "1rem" }}>
                ...
                <tr>
                    <td className="cardBoxElement align-top">
                        Total</td>
                    <td className="">
                        <div id="coins">{numberWithCommas(circCoins)} BTM
                        </div>
                    </td>
                </tr>
                <tr>
                    <td className="cardBoxElement align-top">Max <span className="approx">(approx.)</span></td>
                    <td className="pt-1">28,700,000,000 BTM</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td className="pt-1">{blockReward} BTM</td>
                </tr>
                <tr>
                    ...
                    <td className="pt-1">{halvingDate}<br /><div className="text-end w-100 pe-3 pt-1" style={{ fontSize: "small" }}>to {halvingAmount} BTM</div></td>
                </tr>
            </table>
        </div>
    </>
